...
class PaymentNotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post payment_notifications_url, params: { payment_notification: { cart_id: @payment_notification.cart_id, create: @payment_notification.create, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id } }
    end
  ...
  test "should update payment_notification" do
    patch payment_notification_url(@payment_notification), params: { payment_notification: { cart_id: @payment_notification.cart_id, create: @payment_notification.create, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id } }
